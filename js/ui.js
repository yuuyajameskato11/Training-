...
const UI = (() => {
  ...
  function renderSettings() {
    ...
    html += `<div class="section-title">Lift cards</div><div class="card">
      <div class="sub" style="margin:0 0 10px">The coach's Summer '13 cards — advanced, team and dev — driven off your own maxes.</div>
      <a class="btn ghost" href="liftcards.html" style="text-decoration:none">Open lift cards →</a>
    </div>`;
